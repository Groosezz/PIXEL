...
#srun torchrun --nnodes=2\
 ...
 srun --ntasks=16 --tasks-per-node=4 python ./scripts/our_model/pretrain_bart.py ./new_configs/pretrain_bart_binary_focal_noise.json
